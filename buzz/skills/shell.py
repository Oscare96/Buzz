...
class ShellCommandSkill(Skill):
    ...
    argument_schema={"type":"object","properties":{"argv":{"type":"array","items":{"type":"string","maxLength":4096},"minItems":1,"maxItems":64},"cwd":{"type":["string","null"]}},"required":["argv"],"additionalProperties":False}
